...
#define DIVRULES_INTERFACEID 2
  ...
  typedef divrules_ornode (*divrules_expand_fun)(void* moddata, divrules_div node, divrules_rangelist excl);
  typedef void (*divrules_free_moddata_fun)(void* moddata);
  //typedef void (*divrules_free_ornodeonly_fun)(void* moddata, divrules_ornode* ornode);
  typedef divrules_ornode (*divrules_get_root_fun)(void* moddata, struct fomus_rat time, struct module_list initdiv); // pass it an initial div list
  ...
  typedef struct fomus_rat (*divrules_endtime_fun)(void* moddata, divrules_div node);
  ...
  typedef fomus_rat (*divrules_leveldur_fun)(void* moddata, divrules_div node, int lvl);
  typedef int (*divrules_istupletbegin_fun)(void* moddata, divrules_div node, int lvl);
  typedef int (*divrules_istupletend_fun)(void* moddata, divrules_div node, int lvl);
...
//   typedef module_list (*divrules_gettupdivs_fun)();
  ...
  struct divrules_data { // must all be the right types, or fomus will barf
    ...
    int dotnotelvl_setid, dbldotnotelvl_setid, slsnotelvl_setid, syncnotelvl_setid; // set to <0 for none
    //int mintupdur_setid, maxtupdur_setid; //, /*maxtups_setid,*/ tuprattype_setid; //, tupdivs_setid; these divrules should look up
  };
  ...
  struct divrules_iface {
    ...
    //divrules_free_ornodeonly_fun free_ornodeonly; // freeds or-node and nested and-nodes, but not nodes
