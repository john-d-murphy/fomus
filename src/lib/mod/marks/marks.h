...
namespace marks {
  ...
  inline const char* name() {return "marks";};
  inline const char* prettyname() {return "Marks";}
  inline const char* author() {return "(built-in)";}
  inline const char* doc() {return "Processes marks.";}
  ...
  inline enum module_type modtype() {return module_modmarklayouts;}
  ...
  inline int itertype() {return module_bymeas | module_byvoice;}
