...
// int dist_interfaceid() {return DIST_INTERFACEID;} // divrules.cc must provide
// a unique one in header divrules.h file
...
const char* module_doc() {
  return "Calculates distance between two objects by adding temporal "
         "difference (beats) to difference in pitch (i.e. the \"block\" "
         "distance if time and pitch are the axes on a two-dimensional grid).";
}
