...
namespace rstaves {
  ...
  inline const char* name() {return "rstaves";};
  inline const char* prettyname() {return "Rest Staves";}
  inline const char* author() {return "(built-in)";}
  inline const char* doc() {return "Distributes rests to staves.  Rests are treated separately since their placement largely depend on "
  ...
  inline enum module_type modtype() {return module_modrstaves;}
  ...
  inline int itertype() {return module_bypart | /*module_nograce |*/ module_byvoice;}
