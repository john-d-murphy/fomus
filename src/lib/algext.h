...
namespace FNAMESPACE {
  ...
  struct ll_hassome {
    ...
    template<typename I, typename T>
    bool operator()(const I& a, const I& b, T& c) const {return hassome(a, b, c);}
  };
#endif
  ...
  struct ll_hasnone {
    typedef bool result_type;
    template<typename I, typename T>
    bool operator()(const I& a, const I& b, T& c) const {return hasnone(a, b, c);}
  };
#endif
  ...
  struct ll_hasall {
    typedef bool result_type;
    template<typename I, typename T>
    bool operator()(const I& a, const I& b, T& c) const {return hasall(a, b, c);}
  };
#endif
  ...
  struct ll_for_each_it {
    ...
    struct sig {
      typedef typename boost::remove_cv<typename boost::tuples::element<3, Args>::type>::type type;
    };
    template<typename I, typename F>
    F operator()(const I& a, const I& b, F& c) const {return for_each_it(a, b, c);}
  };
#endif
  ...
  struct ll_for_each2 {
    template<typename Args>
    struct sig {
      typedef typename boost::remove_cv<typename boost::tuples::element<4, Args>::type>::type type;
    };
    template<typename I1, typename I2, typename F>
    F operator()(const I1& a, const I1& b, const I2& c, F& d) const {return for_each2(a, b, c, d);}
  };
#endif
  ...
  struct ll_for_each_reverse {
    ...
    template<typename I, typename F>
    F operator()(const I& a, const I& b, F& c) const {return for_each_reverse(a, b, c);}
  };
#endif
  ...
  struct ll_for_each_it_reverse {
    ...
    template<typename I, typename F>
    F operator()(const I& a, const I& b, F& c) const {return for_each_it_reverse(a, b, c);}
  };
#endif

  template<typename I>
  inline typename std::iterator_traits<I>::difference_type match_count(I first1, const I& last1, I first2, const I& last2) {
  ...
  struct ll_maximize {
    ...
    template<typename R, typename I, typename F>
    R operator()(const I& a, const I& b, F& c, const R& d = 0) const {return maximize(a, b, c, d);}
  };
#endif
  ...
  struct ll_minimize {
    ...
    template<typename R, typename I, typename F>
    R operator()(const I& a, const I& b, F& c, const R& d = 0) const {return minimize(a, b, c, d);}
  };
#endif
  ...
  inline void copy_ptrs(I first1, const I& last, T first2) {
    while (first1 != last) *(first2++) = &(*first1++);
  }
  ...
  struct range:public modutil_range {
    ...
    bool operator<(const range& x) const {return x2 < x.x1;}
  ...
  public:
    ...
    ranges(const range& fill):std::multiset<range>() {insert(fill);}
	...
	if (x.x1 > i1->x1) x.x1 = i1->x1;
	iterator i0(boost::prior(i2));
	if (x.x2 < i0->x2) x.x2 = i0->x2;
	erase(i1, i2);
      }
      insert(x);
    }
	...
	erase(i1, i2);
	if (t1 < x.x1) insert(range(t1, x.x1));
	if (x.x2 < t2) insert(range(x.x2, t2));
      }
    }
